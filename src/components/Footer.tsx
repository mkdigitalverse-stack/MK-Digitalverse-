...
export const Footer: React.FC<FooterProps> = ({ onSelectIndustry, onOpenAuditModal }) => {
  return (
    <footer className="bg-[#050505] border-t border-white/10 text-zinc-400 text-xs">
      
      {/* Top CTA Banner */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-white/10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-8 rounded-2xl glass-panel bg-[#09090b] border border-white/10">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white">
              Ready to deploy an integrated revenue growth engine?
            </h3>
            <p className="text-xs text-zinc-300 mt-1">
              Transform your patient acquisition or luxury venue booking model with MK Digitalverse.
            </p>
          </div>

          <button
            onClick={onOpenAuditModal}
            className="px-6 py-3.5 rounded-full bg-white text-black font-bold text-xs uppercase tracking-wider hover:bg-zinc-200 active:scale-95 transition-all shrink-0 shadow-lg"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-zinc-800 border border-white/20 p-[1px]">
              <div className="w-full h-full bg-[#050505] rounded-[7px] flex items-center justify-center font-black text-white text-lg">
                MK
              </div>
            </div>
          ...
          <p className="text-xs text-zinc-400 leading-relaxed max-w-sm">
            MK Digitalverse is a premier Digital Growth Partner. We architect integrated business growth systems for healthcare organizations and luxury wedding venues across India.
          </p>

          <div className="space-y-2 text-zinc-300 pt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Direct Executive Desk: Available via Audit Request</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-zinc-400">
            ...
            <li><a href="#capabilities" className="hover:text-white transition-colors">Headless Web Engineering</a></li>
        ...
        <div className="space-y-3">
          <h4 className="text-white font-bold uppercase tracking-wider text-xs flex items-center gap-1.5">
            ...
            <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-zinc-800 text-emerald-400 border border-white/10">
              Future
            </span>
          </h4>
      ...
      {/* Bottom Copyright */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-zinc-500">
        <div>
          © {new Date().getFullYear()} MK Digitalverse. All rights reserved. Official Digital Growth Partner.
        </div>
        <div className="flex items-center gap-6">
          <a href="#" className="hover:text-zinc-300 transition-colors">Privacy Policy</a>
          <a href="#" className="hover:text-zinc-300 transition-colors">Terms of Growth Engagement</a>
          <a href="#" className="hover:text-zinc-300 transition-colors">Security Standards</a>
        </div>
      </div>
