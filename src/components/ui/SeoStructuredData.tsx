...
export const SeoStructuredData: React.FC = () => {
  const organizationSchema = {
    ...
    'description': 'Premier Digital Growth Partner for Healthcare Organizations.',
    'knowsAbout': [
      'Healthcare Patient Acquisition',
      'Hospital Marketing Systems',
      'Clinical Reputation Engineering',
      'AI Lead Pre-Qualification',
      'High-Converting Healthcare Web Development',
  ...
  const breadcrumbSchema = {
    ...
    'itemListElement': [
      ...
      },
      {
        '@type': 'ListItem',
        'position': 2,
        'name': 'Healthcare Growth Systems',
